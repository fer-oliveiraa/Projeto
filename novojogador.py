...
def ajustar_elementos(screen):
    ...
    tamanho_personagem = int(largura_tela * 0.18)  
    ...
    area_clique_esquerda = pygame.Rect(
        pos_personagem1[0] - distancia_afastamento - 65,  
        pos_personagem1[1],
        50,
        tamanho_personagem
    )
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if imagem_ins_rect.collidepoint(event.pos):
                    ...
                    if nome_jogador == 'Insira seu nome aqui' or nome_jogador == "":
                        nome_jogador = "Jogador 1"  
                    
                   
                    if mostrar_personagem1:
                        avatar_path = 'Imagens/personagem1.png'
                    else:
                        avatar_path = 'Imagens/personagem2.png'
                    
                   
                    exibir_tema(screen, nome_jogador, avatar_path)
